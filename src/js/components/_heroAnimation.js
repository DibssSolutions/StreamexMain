...
// new TimelineMax()
//   .set('.js-hero-coin-bottom', { transformOrigin:'50% 50%', scale: 0})
//   .set('.js-hero-coin-bottom-left', { transformOrigin:'50% 50%'});


const tlCoinBottomFirst = new TimelineMax({paused: true})
  .set('.js-hero-coin-bottom', { transformOrigin:'50% 50%', scale: 0, xPercent: 35})
...
const tlCoinBottomSecond = new TimelineMax({paused: true})
  .add(tlCoinBottomFirst.paused('true'), 0)
...
const tlCoinBottomThird = new TimelineMax({paused: true})
  .add(tlCoinBottomSecond.paused('true'), 0)
  .to('.js-hero-coin-bottom', 0.7, {
    yPercent: 75,
    scale: 0,
    ease: Power4.easeOut
...
setTimeout(() => {
  new TimelineMax()
    // .add(tlCoinBottomFirst.play(), 0)
    // .add(tlCoinBottomSecond.play(), 0)
    // .add(tlCoinBottomThird.play(), 3.2)
  ...
  //       ease: Power0.easeNone
  //     }, 1)
  //     .from('.js-hero-coin-bottom', 1.4, {
  //       scale: 0,
  //       yPercent: 75,
  //       ease: Power0.easeNone
  //     }, 0)
  //     .to('.js-hero-coin-bottom', 1.4, {
  //       yPercent: 10,
  //       scale: 1,
  //       ease: Power0.easeNone
  //     }, 0)
  //     .to('.js-hero-coin-bottom', 0.5, {
  //       yPercent: 75,
  //       scale: 0,
  //       ease: Power4.easeOut
  //     }, 5.6);
  ...
  //   //   ease: Power0.easeNone
  //   // }, 1)
  //     .from('.js-hero-coin-bottom-left', 0.5, {
  //       scale: 0,
  //       yPercent: 75,
  //       scale: 1,
  //       ease: Power4.easeOut
  //     }, 0)
  //     .to('.js-hero-coin-bottom-left', 0.5, {
  //       yPercent: 10,
  //       scale: 1,
  //       ease: Power4.easeOut
  //     }, 0)
